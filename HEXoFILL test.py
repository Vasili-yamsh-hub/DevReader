...
class MainWin(tk.Tk):
    ...
    def FTDI_BOOT_ON(self):
        ...
        d.setBitMode(0xF1,mode) #Set bits 1 to 4 to output and make bits 1 to 3 high: 0xFF(0b1111[mask] 0001[data])

        time.sleep(0.1)

        d.setBitMode(0xF3,mode) #0011
    ...
    def FTDI_BOOT_OFF(self):
        ...
        d.setBitMode(0xf1,mode) #Set all pins to output with bit 0 high: 0xF1(0b1111[mask] 0001[data])
        d.setBitMode(0xF0,mode) #0xFD(0b1111[mask] 0000[data])

        time.sleep(0.1)

        d.setBitMode(0xF2,mode)
